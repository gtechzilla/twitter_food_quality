...
def data_download(keyword_list,date_since):
    ...
    for keyword in keyword_list:
        ...
        tweets = tw.Cursor(api.search,q=keyword,geocode = "6.48937,3.37709,1200km",since=date_since).items(1000000)
        ...
        tweet_text.to_csv('nigeria_{keyword}.csv'.format(keyword=keyword))
...
hashtags_list=["#foodquality","#foodsafety","#foodtech","#foodpollution","#foodpoisoning","#safefood" ,"#indoorfoodquality",
          "#food","#foodsafetyjobs","#indoorfood","#FSMA","#healthyeatting" , "#IAFP", 

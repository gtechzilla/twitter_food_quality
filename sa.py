...
def data_download(keyword_list,date_since):
    ...
    for keyword in keyword_list:
        ...
        tweets = tw.Cursor(api.search,q=keyword,geocode = "-26.22081,28.03239,1000km",since=date_since).items(1000000)
        ...
        tweet_text.to_csv('sa_{keyword}.csv'.format(keyword=keyword))
